...
namespace DataAccessLayer
{
    public class NhaCungCapRepository : INhaCungCapRepository
    {
        ...
        public bool Create(NhaCungCapModel model)
        {
            ...
            try
            {
                var result = _dbHelper.ExecuteScalarSProcedureWithTransaction(out msgError, "sp_them_ncc",
        ...
        public bool Update(NhaCungCapModel model)
        {
            ...
            try
            {
                var result = _dbHelper.ExecuteScalarSProcedureWithTransaction(out msgError, "sp_update_ncc",
        ...
        public bool Delete(string id)
        {
            ...
            try
            {
                var result = _dbHelper.ExecuteScalarSProcedureWithTransaction(out msgError, "sp_delete_ncc",
                "@MaDanhGia", id);
                if ((result != null && !string.IsNullOrEmpty(result.ToString())) || !string.IsNullOrEmpty(msgError))
                {
                    throw new Exception(Convert.ToString(result) + msgError);
